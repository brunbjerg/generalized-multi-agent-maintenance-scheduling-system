...
\frame{\titlepage}
\begin{frame}{Agenda}{FiraCode Nerd Font}
    \begin{itemize}
...
\begin{frame}[t]{Architecture}
	\drawGraph{basisinput=1cm}
\end{frame}

\begin{frame}[t]{Architecture}
	\drawGraph{basisinput=1cm, show_orchestrator=true}
\end{frame}
...
\begin{frame}[t]{}
    \begin{block}{Dynamic versus Static Models}
		...
		\begin{itemize}
			...
			\item Remember: The real optimial solution is ever knowable at time = 0
		\end{itemize}
    \end{block}
\end{frame}
