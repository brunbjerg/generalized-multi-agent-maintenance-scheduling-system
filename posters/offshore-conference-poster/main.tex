...
\block[titleinnersep=0.8cm, roundedcorners=0.2cm, titleleft]{Introduction}{
	...
	the decisions taken by each individual stakeholder making up the scheduling process. Which is the most general 
	form is composed of a Scheduler, a set of Supervisors, and groups of technicians that are lead by the supervisors. 
	It is generally believe that maintenance efficiency can be increased by $~$35\%  \parencite{palmerMaintenancePlanningScheduling2019} by having a well organized maintenance
	scheduling system in place. This project will provide an implementable architecture that is able to model and optimize
...
\subcolumn{0.5} 
\block[titleinnersep=0.5cm, roundedcorners=0.2cm, titleleft, bodyinnersep=0.5cm]{Future Work}{
	\begin{itemize}
		\item Test Scheduling Application with case company
		\item 
	\end{itemize}
}
...
\block[roundedcorners=0.2cm, bodywidthscale=1.0, bodyverticalshift=0cm]{}{
	...
	\end{minipage}
	\begin{minipage}[c][3in][t]{0.71\linewidth}
		Contact Information:
		\begin{itemize}
