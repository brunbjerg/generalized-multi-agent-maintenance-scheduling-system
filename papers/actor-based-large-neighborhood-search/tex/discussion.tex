...
allows for.
% DEBUG: Should you mention "hierarchical" here? I am not really sure. I think that is would be best to avoid it. The issue
% here is that the non-hierarchical part of the setup comes from the pointer-swapping and not the message queue. I think
% that is crucial to understand in all of this. Should you elaborate on it? I think that it would be better to 
% mention the effects of the pointer swapping structure instead. I think that you be the best course of action. 
