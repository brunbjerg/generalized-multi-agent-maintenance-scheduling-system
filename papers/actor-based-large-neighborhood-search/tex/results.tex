...
associated with a specific offshore platform that for the time horizon that we are looking at contains 3487 outstanding work orders ($\SetWorkOrder{}$), have 16 
different resource skill sets ($\SetResource$) (e.g. mechanics, electricians, turbine specialists, etc.), and finally the scheduling horizon stretches over
a 52 bi-weekly periods ($\SetPeriod$) meaning approximately 2 years.
