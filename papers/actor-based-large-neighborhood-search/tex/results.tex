...
tested in Section~\ref{sec:reduced_weekly_capacity} and increasing them is tested in 
Section~\ref{sec:increase_week_cap}. Finally the effect of changing item weights, i.e. workorder resource requirements, is tested in Section~\ref{sec:weight_changes}.
...
\subsection{Response to Reduced Weekly Capacity}\label{sec:reduced_weekly_capacity}
...
\subsection{Response to Changes in Item Weights}\label{sec:weight_changes}
