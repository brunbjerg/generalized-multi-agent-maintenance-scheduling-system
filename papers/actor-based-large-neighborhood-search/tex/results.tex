...
\begin{table}[H]
	...
	\makecell{$ \ParStrategicValue[\VarMetaTime_{n}] -$\\ $\ParStrategicValue[\VarMetaTime_{n - 1}]$}        & $3.75 \cdot 10^{7}$                                           & $3.75 \cdot 10^{7}$                                            & $3.75 \cdot 10^{7}$                                            & $3.75 \cdot 10^{7}$                                            & $3.75 \cdot 10^{7}$                                       \\ \hline
	\end{tabular}
