...
This data instance is provided by Total Energies~\cite{total-energies}. The data
...
and when the system is pertubed by an input response the objective value
\ref{eqn:objective:strategic} shows a small spike and then quickly converges to
a new solution.
...
\begin{table}[H]
	...
	\begin{tabular}{|c|c|c|c|c|c|}
	\hline
	                                  & \begin{tabular}[c]{@{}c@{}}$\VarMetaTime_1 = 0$\end{tabular}  & \begin{tabular}[c]{@{}c@{}}$\VarMetaTime_1 = 100$\end{tabular}   & \begin{tabular}[c]{@{}c@{}}$\VarMetaTime_2 = 200$\end{tabular}    & \begin{tabular}[c]{@{}c@{}}$\VarMetaTime_3 = 300$\end{tabular} \\ \hline
	$\Delta |\SetPeriod|$             & 52                                                              & 52                                                               & 52                                                                & 52                                                             \\ \hline
	$\Delta |\SetResource|$           & 16                                                              & 16                                                               & 16                                                                & 16                                                             \\ \hline
	$ |\ParStrategicResource{}|$ (hours)& 111268                                                          &  61816                                                           & 111268                                                            & 173083                                                          \\ \hline
	\end{tabular}
...
\begin{table}[H]
	...
	$\Delta |\SetPeriod|$             & 52                                                             & 52                                                             & 52                                                                & 52                                                             \\ \hline
	$\Delta |\SetResource|$           & 16                                                             & 16                                                             & 16                                                                & 16                                                             \\ \hline
	$ |\ParStrategicResource{}|$ (hours)& 111268                                                        & 173083                                                         & 111268                                                            & 61816                                                           \\ \hline
	\end{tabular}
	\caption{The resource perturbations that the AbLNS will be affected by measured in hours. Here all $\ElementPeriod \in \SetPeriod$ and $\ElementResource \in \SetResource$ are 
		affected}
