...
\begin{itemize}
	\item To provide a modular scalable optimization component based on a proven metaheuristic to allow business processes to be composed from smaller mathematical models, instead of larger integrated formulations.
\end{itemize}

The paper is divided into four different sections. Section \ref{sec:2-solution-method} explains the weekly maintenance scheduling model in detail and forms the foundation of the paper. Section \ref{sec:3-results} shows the results coming from the implemented metaheuristic where it will be affected by simulated user-interaction. Section \ref{sec:4-discussion} will discuss the implications of the research and set a future research direction.
% DEBUG: What is tau her
...
% TODO: Explain the metavariables.
% TODO: Format the model correctly.
% TODO: Use pgfkeys to conditionally compile the document.
