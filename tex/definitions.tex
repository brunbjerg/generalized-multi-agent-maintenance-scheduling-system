...
\newcommand{\SetMessageQueue}{M}
\newcommand{\ElementMessage}[2]{m_{#1}^{#2}}

% Parameters
\newcommand{\ParStrategicUrgency}[1][\VarMetaTime]{strategic\_urgency_{\ElementWorkOrder\ElementPeriod}(#1)}
\newcommand{\ParStrategicResourcePenalty}{strategic\_resource\_penalty}
\newcommand{\ParClusteringValue}{clustering\_value_{\ElementWorkOrder1, \ElementWorkOrder2}}
\newcommand{\ParStrategicResource}[2]{resource_{\ElementPeriod\ElementResource#2}(\VarMetaTime#1)}

\newcommand{\ParStrategicWorkOrderWorkLoad}{work\_order\_workload_{\ElementWorkOrder \ElementResource}}
\newcommand{\ParStrategicTechnicianWork}[1]{technician\_work_{\ElementPeriod\ElementTechnician}(\VarMetaTime#1)}
\newcommand{\ParTechnicianSkill}[0]{technician\_skills_{\ElementResource\ElementTechnician}(\VarMetaTime)}

\newcommand{\ParStrategicInclude}{include_{\ElementWorkOrder\ElementPeriod}(\VarMetaTime)}
\newcommand{\ParStrategicExclude}{exclude_{\ElementWorkOrder\ElementPeriod}(\VarMetaTime)}
...
\newcommand{\VarStrategicResource}[2]{\psi_{\ElementPeriod\ElementResource#2}(\VarMetaTime#1)}
...
\newcommand{\VarTacticalResource}[0]{\Psi_{\ElementDays\ElementResource\ElementTechnician}(\VarMetaTime)}
...
\newcommand{\VarSupervisorOperationWhole}{\phi_{\ElementOperation}(\VarMetaTime)}
\newcommand{\VarSupervisorWorkOrderWhole}{\Phi_{\ElementWorkOrder}(\VarMetaTime)}
...
\newcommand{\ParMessageQueue}[1]{Q_{#1}}
